...
import com.realmate.engine.payload.response.JwtResponse;
...
import com.realmate.engine.payload.request.LoginRequest;
import com.realmate.engine.payload.request.SignupRequest;
import com.realmate.engine.payload.response.MessageResponse;
import com.realmate.engine.repository.RoleRepository;
import com.realmate.engine.repository.UserRepository;
import com.realmate.engine.security.jwt.JwtUtils;
import com.realmate.engine.security.services.UserDetailsImpl;
...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		User user = new User(signUpRequest.getName(),
							 ...
							 signUpRequest.getPropic(),
							 signUpRequest.getEmail(),
							 signUpRequest.getGender(),
							 signUpRequest.getGenderPreference(),
